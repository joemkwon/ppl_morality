...
def main():
    ...
    parser.add_argument(
        ...
        type=str, 
        nargs='?', 
        default=os.path.join(SCRIPT_DIR, "experiment_stimuli", "exp1_stimuli_no_sign", "experiment_config.json"), 
    ...
    parser.add_argument(
        ...
        type=str, 
        nargs='?', 
        default=os.path.join(SCRIPT_DIR, "experiment_results", "gpt4_experiment1_no_sign", "experiment_results.json"), 
